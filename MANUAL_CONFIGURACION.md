...
Si deseas habilitar notificaciones por correo al registrar notas:
...
Si tienes un archivo de fixtures con datos de prueba:
...
**IMPORTANTE:** Completar con las credenciales reales del sistema desplegado.
...
- **Superusuario:**
  - Username: `admin`
  - Password: `(el que creaste con createsuperuser)`
...
- **Seguridad:** Nunca subir el archivo `.env` a GitHub
- **Backups:** Hacer respaldo regular de la base de datos
- **Actualizaciones:** Mantener Django y dependencias actualizadas
- **Testing:** Probar en local antes de desplegar a producción
